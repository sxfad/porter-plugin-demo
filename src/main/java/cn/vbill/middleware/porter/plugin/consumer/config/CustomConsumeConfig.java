...
package cn.vbill.middleware.porter.plugin.consumer.config;
 ...
 */
public class CustomConsumeConfig extends SourceConfig implements PluginServiceConfig {
    @Override
    public String getConfigName() {
        return "CustomConsumeConfig";
    }
